...
export const getMe = async (req, res) => {
    try {
        ...
        result['notGiven'] = await OrderModel.find({reader: {_id: userData._id}, isCancled: false, isGiven: false}).populate("book");
        result['active'] = await OrderModel.find({reader: {_id: userData._id}, isCancled: false, isGiven: true, isReturned: false}).populate("book");
